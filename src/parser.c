...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [113] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__cdata_sect, 3),
  [115] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__cdata_sect, 3),
  ...
  [175] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__cdata_sect, 2),
  [177] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__cdata_sect, 2),
